...
CREATE TABLE `dailycheck` (
  `daily_check_id` int(11) NOT NULL AUTO_INCREMENT,
  `operator_id` int(11) DEFAULT NULL,
  `daily_check_start_time` date DEFAULT NULL,
  `daily_check_end_time` date DEFAULT NULL,
  PRIMARY KEY (`daily_check_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `dailycheck`
--
